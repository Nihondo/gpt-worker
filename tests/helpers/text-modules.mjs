...
// asset imports from ./dashboard/*.html, ./dashboard/*.js, and
// ./dashboard/*.css) resolve under
...
// .html, .js, and .css files — so this hook never intercepts an arbitrary project
...
const DASHBOARD_TEXT_ASSET_RE = /\/worker\/src\/dashboard\/[^/]+\.(?:html|js|css)$/;
