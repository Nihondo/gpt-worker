...
- `/mcp`, `/mcp/<workspace_id>` — OAuth-protected shared and per-workspace ChatGPT MCP resources. The shared resource forwards per-tool calls to the right per-workspace DO via an internal `/hub` route.
